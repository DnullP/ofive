/**
 * @module plugins/markdown-codemirror/editor/editorShortcutPolicy
...
export const EDITOR_MANAGED_NATIVE_COMMAND_IDS: EditorNativeCommandId[] = [
    ...
    "editor.toggleInlineLatex",
    "editor.toggleBlockLatex",
...
export const EDITOR_NATIVE_FALLBACK_SHORTCUTS: Record<EditorNativeCommandId, string[]> = {
    ...
    "editor.toggleInlineLatex": ["Cmd+M", "Ctrl+M"],
    "editor.toggleBlockLatex": ["Cmd+Shift+M", "Ctrl+Shift+M"],
    "editor.toggleHighlight": ["Cmd+Shift+H", "Ctrl+Shift+H"],
    "editor.toggleWikiLink": ["Cmd+Alt+K", "Ctrl+Alt+K"],
