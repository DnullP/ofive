...
const en = {
    ...
    /* ==================== App entry ==================== */
    app: {
        homeAriaLabel: "ofive Home",
        homeEyebrow: "Quick start",
        homeTitle: "Start shaping your knowledge workspace",
        homeDescription: "After opening a vault, ofive keeps the file tree, editor, search, and graph in one workbench. Start with a new note, or jump into an existing one to reconnect the thread.",
        homeQuickStartLabel: "Quick start actions",
        homeCreateNote: "Create New Note",
        homeRandomNote: "Open Random Note",
        homeOpenVault: "Open Vault",
        homeNoVault: "No vault open",
        homeLoadingVault: "Loading vault",
        homeNoteCount: "{{count}} Markdown notes",
        homeNoteCountOne: "1 Markdown note",
        homeGuideLabel: "Usage guide",
        homeGuideOpenTitle: "Choose a vault",
        homeGuideOpenDesc: "Use a local notes directory as the workspace; the file tree stays aligned with disk.",
        homeGuideWriteTitle: "Capture the next thread",
        homeGuideWriteDesc: "New notes open in the editor right away for ideas, tasks, and reading fragments.",
        homeGuideExploreTitle: "Return to old material",
        homeGuideExploreDesc: "Random notes are useful for review, while search and graph help you go deeper.",
        explorer: "Explorer",
        calendar: "Calendar",
    ...
    projectReader: {
        ...
        searchPlaceholder: "Search files, symbols, or ast-grep",
        searchModeLabel: "Project search mode",
        searchMode: {
            text: "Text",
            symbol: "Symbol",
            astGrep: "AST",
    ...
    agentSkills: {
        ...
        openFailed: "Failed to open SKILL file",
        createValidation: "Enter a valid name and description.",
        createFailed: "Failed to create SKILL",
        saveFailed: "Failed to save SKILL file",
        created: "SKILL created",
        saved: "Saved",
        referenceCreated: "Reference file created",
        builtIn: "Built-in",
        builtInReadOnly: "Built-in SKILL is read-only",
    },
    ...
    editor: {
        ...
        wikilinkPreviewLoading: "Loading link preview...",
        wikilinkPreviewNotFound: "WikiLink target not found. Preview unavailable.",
        wikilinkPreviewError: "Failed to load link preview.",
    ...
    graph: {
        ...
        renderSettings: "Graph render settings",
        colorGroups: "Color groups",
        addColorGroup: "Add color group",
        colorGroupColor: "Color group color",
        colorGroupQueryPlaceholder: "tag:#Project",
        colorGroupScopeTag: "Tag group",
        colorGroupScopeDirectory: "Directory group",
    ...
    calendar: {
        ...
        loading: "Loading calendar notes...",
        loadFailed: "Load failed: {{message}}",
        noVault: "No vault is currently open.",
        noDateNotes: "No dated notes or scheduled tasks were found in the current vault.",
        ...
        notesForDayEmpty: "No notes for this day yet.",
        itemsForDayCount: "{{count}} items",
        itemsForDayEmpty: "No notes or tasks for this day yet.",
        noteItem: "Note",
        taskItem: "Task",
        taskSource: "{{path}} · line {{line}}",
        taskRepeats: "Every {{value}}",
    ...
    settings: {
        ...
        aiSection: "AI Chat",
        semanticIndexSection: "Semantic Index",
        semanticIndexSectionDesc: "Embedding models, vector retrieval readiness, and background indexing status.",
        /* General */
        ...
        enableNotifications: "Enable Frontend Notifications",
        enableNotificationsDesc: "When off, the frontend will no longer show notification popups",
        notificationsMaxVisible: "Max Visible Notifications",
        notificationsMaxVisibleDesc: "Maximum number of notifications displayed at the same time",
        notificationsMaxVisibleSuffix: "items",
        restoreWorkspaceLayout: "Restore Workspace Layout on Restart",
        restoreWorkspaceLayoutDesc: "When enabled, sidebar layout and tab state will be restored from the previous session",
        fileOpenMode: "Note Open Behavior",
        fileOpenModeDesc: "Choose whether WikiLinks and file tree note opens create a new tab or replace the currently focused file tab.",
        fileOpenModeNewTab: "Open New Tab",
        fileOpenModeNewTabDesc: "Keep the current note and open the target note in the current group.",
        fileOpenModeReplaceActive: "Replace In Place",
        fileOpenModeReplaceActiveDesc: "Prefer reusing the focused file tab; if focus is not on a file tab, open a new tab.",
        /* Frontmatter Template */
        frontmatterSection: "Frontmatter",
        frontmatterSectionDesc: "Configure the template content when inserting Frontmatter.",
        frontmatterAutoInsertOnCreate: "Auto Insert Frontmatter for New Notes",
        frontmatterAutoInsertOnCreateDesc: "When enabled, Markdown notes created from the file tree or new-file command start with the template below.",
        frontmatterTemplate: "Frontmatter Template",
        frontmatterTemplateDesc: "Supported placeholders: {{filename}} file name, {{date}} current date, {{directory}} parent directory.",
        frontmatterTemplatePlaceholder: "Enter YAML template content…",
        /* Theme */
        themeSection: "Style",
        ...
        tabRestoreMode: "Tab Restore Mode",
        tabRestoreModeDesc: "When switching back to an editor tab or rebuilding it, either preserve the saved viewport without re-entering edit focus, or restore edit focus and reveal the saved caret.",
        tabRestoreModeViewport: "Preserve viewport without edit focus",
        tabRestoreModeCursor: "Restore edit focus and caret",
        tabOut: "Tab Out of Brackets",
        tabOutDesc: "When the cursor is before a closing bracket, Tab moves after it; other positions still indent",
    ...
    commands: {
        ...
        toggleInlineLatex: "Toggle Inline LaTeX",
        toggleBlockLatex: "Toggle Block LaTeX",
        toggleHighlight: "Toggle Highlight",
        toggleWikiLink: "Toggle WikiLink",
        insertLink: "Insert Link",
        insertTask: "Quick Insert Task",
        insertFrontmatter: "Insert Frontmatter",
        insertTable: "Insert Table",
        segmentedDeleteBackward: "Segmented Delete Backward",
    ...
    markdownTable: {
        ...
        columnHandleTitle: "Select, drag, or right-click column",
        rowHandleTitle: "Select, drag, or right-click row",
        resizeColumnTitle: "Drag to resize column",
        resizeRowTitle: "Drag to resize row",
        shortcutTabNavigation: "Tab / Shift+Tab",
        shortcutReorder: "Alt+Arrows",
        shortcutDeleteContent: "Alt+Backspace",
        synced: "Table synced",
    ...
    architectureDevtools: {
        ...
        reverseModuleDependencies: "Reverse module dependencies ({{count}})",
        copyReverseModuleDependencies: "Copy reverse dependency details",
        copyReverseModuleDependenciesCopied: "Reverse dependency details copied",
        copyReverseModuleDependenciesFailed: "Copy failed, check clipboard permission",
    ...
    taskBoard: {
        ...
        title: "Task Board",
        description: "Query task syntax across the whole vault and adjust schedule, recurrence, or priority in place.",
        refresh: "Refresh",
        open: "Open",
        edit: "Edit",
        columns: "Columns",
        configureColumns: "Configure board columns",
        addColumn: "Add column",
        editBoard: "Edit board",
        saveBoardEdit: "Save edit",
        statusAll: "All",
        statusOpen: "Open",
        statusDone: "Done",
        ...
        editSubtitle: "Update schedule, recurrence, and priority for this task line.",
        syntaxHint: "Saved as start:2026-03-24 09:00 end:2026-03-24 11:00 every:weekly-tue !high",
        clearTime: "Clear",
        startLabel: "Start",
        endLabel: "End",
        ...
        recurrenceWeeklyOn: "Weekly on {{day}}",
        recurrenceMonthly: "Monthly",
        recurrenceMonthlyOn: "Monthly on day {{day}}",
        ...
        customColumnsSummary: "Filter by time, tag, folder, status, and priority",
        noCustomColumns: "No custom columns yet.",
        newCustomColumnName: "New column",
        ...
        filterValueToLabel: "End value",
        filterValueToPlaceholder: "2026-03-31",
        filterValuePlaceholder: "Enter value",
        filterValueTagPlaceholder: "Tag name",
        filterValueDirectoryPlaceholder: "Folder fragment",
        removeCondition: "Remove condition",
        addCondition: "Add condition",
        customColumnFallbackTitle: "Custom column",
        addColumnTitle: "Add column",
        editColumnTitle: "Edit column",
        configureColumn: "Configure {{column}}",
        reorderColumn: "Drag {{column}} to reorder",
        closeColumnSettings: "Close column settings",
        saveColumn: "Save column",
        resizeColumn: "Resize {{column}} column",
        filterFieldDeadline: "End / due",
        filterFieldStart: "Start",
        filterFieldEnd: "End",
        filterFieldDue: "Legacy due",
        filterFieldTag: "Tag",
        filterFieldDirectory: "Folder",
        filterFieldPath: "Path",
        filterFieldContent: "Content",
        filterFieldTitle: "File name",
        filterFieldStatus: "Status",
        filterFieldPriority: "Priority",
        filterFieldRecurrence: "Recurrence",
        filterOperatorContains: "Contains",
        filterOperatorNotContains: "Does not contain",
        filterOperatorEquals: "Equals",
        filterOperatorNotEquals: "Does not equal",
        ...
        filterOperatorOverdue: "Overdue",
        filterOperatorToday: "Today",
        filterOperatorNext7Days: "Next 7 days",
    },
    ...
    aiChatPlugin: {
        ...
        vendorMissing: "API Key is not configured. Click to open settings.",
        settingsSection: "settings.aiSection",
        settingsTitle: "AI Chat Settings",
        settingsSubtitle: "Create one or more providers, choose the active provider, and fill only the fields required by that provider type.",
        providerLabel: "Provider",
        providerDescription: "Saved provider instances. Switch here to use a different configured account or endpoint.",
        providerNameLabel: "Provider Name",
        providerNameDescription: "A local display name for this provider entry.",
        providerAdd: "Add provider",
        providerRemove: "Remove",
        providerRemoveLast: "Keep at least one AI provider.",
        vendorLabel: "Model Vendor",
        vendorDescription: "Choose the provider type. The field schema is provided by the Rust backend.",
        modelLabel: "Model",
        ...
        contextBudgetDescription: "Set the estimated context size for each AI request. Older messages are compressed before sending when they exceed the budget.",
        autoCompressContextLabel: "Automatically compress older context over budget",
        contextBudgetHint: "Measured in estimated tokens. Tune it to match the selected model context window.",
        ...
        configuredVendor: "Active provider",
        assistant: "Assistant",
        user: "You",
        modelSwitcherTitle: "Switch model",
        modelSwitcherSaving: "Switching model...",
        modelSwitcherEmpty: "No selectable models. Enter a model manually in AI settings.",
        generatingHint: "Generating",
        queuedDraftHint: "Next message ready",
        ...
        toolCallInstance: "Call #{{index}}",
        copyMessage: "Copy",
        copyMessageCopied: "Copied",
        copyMessageFailed: "Failed to copy message.",
        retryMessage: "Retry",
        editMessage: "Edit",
        submitEditedMessage: "Send edited message",
        cancelEditMessage: "Cancel edit",
        rollbackUnavailable: "This message cannot be rolled back in the current session.",
        rollbackIncomplete: "Rollback could not safely restore: {{paths}}",
        toolApprovalTitle: "Tool Approval",
        toolApprovalDescription: "Choose whether each AI tool follows the built-in approval policy, always asks first, or runs automatically while keeping visible call records.",
        toolApprovalDefault: "Default",
        toolApprovalRequire: "Ask first",
        toolApprovalAuto: "Auto run",
        ...
        conversationStopping: "Stopping",
        conversationBackToChat: "Back to chat",
        confirmApprove: "Approve",
        confirmApproveMore: "More approve options",
        confirmAllowConversation: "Allow this conversation",
        confirmAllowOperation: "Always allow this operation",
        confirmAllowOperationUnavailable: "Unable to update approval settings for this tool.",
    ...
    semanticIndexPlugin: {
        settingsTitle: "Semantic Index Settings",
        settingsSubtitle: "Enable vector retrieval explicitly, install embedding models in the background, then choose an installed model as the active index model.",
        fullSyncCommand: "Rebuild Semantic Index Repository",
        noVault: "Open a vault before configuring semantic indexing.",
        loadingSettings: "Loading semantic index settings...",
        refresh: "Refresh",
        enableTitle: "Enable Semantic Index",
        enableDescription: "Disabled by default. When enabled, markdown changes can be queued for background embedding and retrieval.",
        runtimeTitle: "Runtime Stack",
        runtimeDescription: "Current backend selection for embedding provider and vector store.",
        chunkingStrategyTitle: "Chunking Strategy",
        chunkingStrategyDescription: "Choose how markdown files are split before vector indexing. Saving a new strategy requires a full sync to rebuild existing chunks.",
        chunkingStrategyHeadingParagraph: "Heading + Paragraph",
        chunkingStrategyHeadingParagraphDesc: "Split by heading boundaries and paragraph blocks. Best for balanced recall and context density.",
        chunkingStrategyWholeDocument: "Whole Document",
        chunkingStrategyWholeDocumentDesc: "Index each markdown file as a single chunk. Best for short notes or document-level retrieval.",
        searchResultLimitTitle: "Result Limit",
        searchResultLimitDescription: "Maximum number of chunks returned to semantic retrieval callers. This acts as both the default and the hard cap.",
        searchResultLimitRange: "Allowed range: {{min}}-{{max}}",
        statusTitle: "Worker Status",
        queueSummary: "Worker: {{worker}} · Pending files: {{pending}}",
        modelsTitle: "Embedding Models",
        modelsDescription: "Install a model first, then select one installed model as the active embedding target.",
        modelSummary: "Installed {{installed}} / {{total}}",
        install: "Install",
        installSuccess: "Installed {{model}}.",
        saveSuccess: "Semantic index settings saved.",
        selectModel: "Use",
        defaultModel: "Default",
        needInstalledModel: "Install a model and select an installed entry before saving the enabled state.",
        pendingRebuild: "Index-affecting settings changed. Run a full semantic index sync to rebuild existing embeddings.",
        activeModelReady: "The selected model is ready for background indexing.",
        activeModelPending: "The selected model is not ready yet. Install a model before enabling indexing for real use.",
        modelInstalled: "Installed",
        modelInstalling: "Installing...",
        modelFailed: "Install failed",
        ...
        workerPaused: "Paused",
        workerError: "Error",
        syncProgressTitle: "Initial Embedding Sync",
        syncProgressPreparing: "Preparing markdown files for the first full embedding sync...",
        syncProgressRunning: "Embedding sync {{completed}} / {{total}}",
        syncProgressCurrentFile: "Current file: {{path}}",
        syncProgressCompleted: "Initial embedding sync completed.",
        syncProgressCompletedWithFailures: "Initial embedding sync completed with {{failed}} failed files.",
        syncProgressFailed: "Embedding sync failed: {{message}}",
        manualSyncProgressTitle: "Semantic Index Full Sync",
        manualSyncProgressPreparing: "Preparing markdown files for a full semantic index rebuild...",
        manualSyncProgressRunning: "Semantic index sync {{completed}} / {{total}}",
        manualSyncProgressCompleted: "Semantic index full sync completed.",
        manualSyncProgressCompletedWithFailures: "Semantic index full sync completed with {{failed}} failed files.",
        manualSyncProgressFailed: "Semantic index full sync failed: {{message}}",
    },
    ...
    frontmatter: {
        ...
        fieldSuggestions: "Common field suggestions",
        typeString: "String",
        typeNumber: "Number",
        typeBoolean: "Boolean",
        typeList: "List",
